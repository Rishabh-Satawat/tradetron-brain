# =============================================================================
# File: 60-tools/python/export_60days_1m_dataset.py
# Description: Bulk 60-Day 1-Minute Option Chain Extractor with Black-76 Greeks
# Target: ~15,750 One-Minute Bars for NIFTY Monthly Benchmark
...
# --- 1. Black-76 Inverse Greeks Engine ---
...
# --- 2. 60-Day Extraction Controller ---
def extract_60days_dataset(
    option_symbol="NSE:NIFTY26SEP23650CE",
    spot_symbol="NSE:NIFTY50-INDEX",
    strike=23650.0,
    opt_type="CE",
    expiry_str="2026-09-29",
    days_back=60,
):
  ...
  print("=" * 115)
  print(
      f"🎉 COMPLETE: Extracted {len(res_df):,d} 1-minute bars across"
  ...
  csv_file = os.path.join(
      out_dir,
      f"DATASET_60DAYS_1M_{option_symbol.replace(':', '_')}.csv",
  )
  res_df.to_csv(csv_file, index=False)
  print(f"📁 Master 60-Day 1M Dataset saved to:\n   {csv_file}\n")


if __name__ == "__main__":
  # Extract 60-Day 1M dataset for NIFTY 23650 CE
  extract_60days_dataset(
      option_symbol="NSE:NIFTY26SEP23650CE",
      spot_symbol="NSE:NIFTY50-INDEX",
      strike=23650.0,
      opt_type="CE",
  ...
  # Extract 60-Day 1M dataset for NIFTY 23650 PE
  extract_60days_dataset(
      option_symbol="NSE:NIFTY26SEP23650PE",
      spot_symbol="NSE:NIFTY50-INDEX",
      strike=23650.0,
      opt_type="PE",
      expiry_str="2026-09-29",
